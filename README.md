...
Estudante focado em infraestrutura, protocolos de rede, segurança e automação.  
Interesse em ambientes Linux, monitoramento, análise de tráfego e hardening de servidores.
...
- VLANs e Subnetting  
- Serviços de Rede (DNS, DHCP, HTTP, SSH)  
- Firewalls e IDS/IPS  
